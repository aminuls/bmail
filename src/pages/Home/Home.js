      ...
      <div>
         <Container>
                        ...
                        <Card.Body className="d-flex flex-column justify-content-center">
                           <Card.Title>
                              <h1 className="text-uppercase">
                                 <span className="textBlue">Secure </span> <span className="d-inline d-md-block">your </span>
                                 <span className="textBlue">communication </span> <br />
                                 with web3 <span className="textBlue">bmail</span>
                              </h1>
                           </Card.Title>
                           <div>
                              <Card.Text className="text-uppercase fs-6" style={{ letterSpacing: "1px" }}>
                                 Send and receive messages directly between wallets.
                              </Card.Text>
                              <div className="position-relative d-inline-block">
                                 <button className="fw-semibold rounded-4 px-3 py-2 text-uppercase border-0" id="textShadow">
                                    get Bmail
                                 </button>
                                 <p className="position-absolute top-50 start-50 translate-middle w-100 textBlue px-3 py-2 text-uppercase">get Bmail</p>
                              </div>
                           </div>
                        </Card.Body>
                     </Card>
            ...
            <div className="my-5 py-5">
               <h4 className="textBlue fw-normal mt-5 w-100 text-uppercase">bMail provides a secure and private email solution using encryption and blockchain.</h4>
               <div>
                     ...
                     <Card className="text-start bg-transparent text-light h-100">
                        <Card.Body className="d-flex flex-column justify-content-center">
                           <Card.Title className="my-0">
                              <h2 className="my-0">
                                 Send a new <span className="textBlue">Privet Message</span>
                              </h2>
                           </Card.Title>
                           <div>
                  ...
                  <Col>
                     <Card className="text-start bg-transparent text-light h-100">
                        <Card.Body className="d-flex flex-column justify-content-center">
                           <Card.Title className="my-0">
                              <h2 className="my-0">
                                 <span className="textBlue">Share Your Files</span> more Securely
                              </h2>
                           </Card.Title>
                           <div>
                              <Card.Text className="my-0 cardText">
                  ...
                  <Col>
                     <Card className="text-start bg-transparent text-light h-100">
                        <Card.Body className="d-flex flex-column justify-content-center">
                           <Card.Title className="my-0">
                              <h2 className="my-0">
                                 Update yourself with the <span className="textBlue">Crypto News</span>
                              </h2>
                           </Card.Title>
                           <div>
                              <Card.Text className="my-0 cardText">
                     ...
                     <div className="d-flex flex-column gap-4 text-center text-md-start text-uppercase text-light">
                        ...
                        <div>
                           <div className="d-flex gap-3 justify-content-center justify-content-md-start">
                              <a href="#" className="position-relative d-inline-block text-decoration-none text-light">
